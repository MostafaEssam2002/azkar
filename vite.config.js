...
const securityHeadersMiddleware = (req, res, next) => {
  ...
  res.setHeader('Content-Security-Policy', "default-src 'self'; script-src 'self' 'wasm-unsafe-eval'; connect-src 'self' https://api.quranpedia.net https://cdn.quranpedia.net https://quranenc.com https://cdn.islamic.network; style-src 'self' 'unsafe-inline' https://cdn.jsdelivr.net https://fonts.googleapis.com; img-src 'self' data: https:; font-src 'self' data: https://fonts.gstatic.com https://cdn.jsdelivr.net; media-src 'self' https://cdn.islamic.network https://quranenc.com https://backup.qurango.net; object-src 'none'; frame-ancestors 'none'; base-uri 'self'; form-action 'self'");
