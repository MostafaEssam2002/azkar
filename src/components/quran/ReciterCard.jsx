...
const ReciterCard = ({id, name, ar_name, rawi, timing_url, server, surahs_count, surahs_list}) => {
    ...
    const getReciterImage = (reciterName) => {
        const imageMapping = {
            ...
            'إسلام صبحي': '/reciters_images/إسلام صبحي.jpg',
            'ابراهيم الجبرين': '/reciters_images/ابراهيم الجبرين.jpg',
            'ابراهيم السعدان': '/reciters_images/ابراهيم السعدان.jpg',
            'ابراهيم العسيري': '/reciters_images/ابراهيم العسيري.jpg',
            'استاذ زامري': '/reciters_images/استاذ زامري.jpg',
            'الحسيني العزازي': '/reciters_images/الحسيني العزازي.jpg',
            'الزين محمد أحمد': '/reciters_images/الزين محمد أحمد.jpg',
            'العشري عمران': '/reciters_images/العشري عمران.jpg',
            'بدر التركي': '/reciters_images/بدر التركي.jpg',
            'حسين آل الشيخ': '/reciters_images/حسين آل الشيخ.jpg',
            'حمد الدغريري': '/reciters_images/حمد الدغريري.jpg',
            'خالد الشارخ': '/reciters_images/خالد الشارخ.jpg',
            'خالد الغامدي': '/reciters_images/خالد الغامدي.jpg',
            'رشيد إفراد': '/reciters_images/رشيد إفراد.jpg',
            'رعد محمد الكردي': '/reciters_images/رعد محمد الكردي.jpg',
            'رمضان شكور': '/reciters_images/رمضان شكور.jpg',
            'زكي داغستاني': '/reciters_images/زكي داغستاني.jpg',
            'سامي الدوسري': '/reciters_images/سامي الدوسري.jpg',
        };
